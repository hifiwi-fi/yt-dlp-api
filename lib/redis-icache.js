 ...
 * delegating Redis operations to the owning Fastify process over worker IPC.
 * Workers intentionally do not create external Redis connections or receive
 * Redis credentials, which keeps connection count independent of pool size.
 *
